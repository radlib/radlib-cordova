...
function directConnectLFParsed(){
	bluetoothScanner.connectParsed(updateTable, dumpLog, "20:14:05:08:15:63");
}
...
function updateTable(object) {
	...
	db_object.reader = "TSL 1128 Reader";
...
function db_init() {
	...
	var db = openDatabase("tslDatabase", "1.0", "TSL DB", dbSize, null);
...
function db_updateCount(object) {
	var dbSize = 5 * 1024 * 1024;
	var db = openDatabase("tslDatabase", "1.0", "TSL DB", dbSize);
